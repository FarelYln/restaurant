        ...
        <div class="container my-5 py-5">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <a href="#menu" class="btn btn-primary py-sm-3 px-sm-5 me-3 animated slideInLeft">Reservasi Sekarang</a>
                </div>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Pesan Online</h5>
                                <p>Pesan hidangan favorit Anda secara mudah dan cepat melalui layanan pemesanan online kami.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Layanan 24/7</h5>
                                <p>Kami selalu siap melayani Anda kapan saja, 24 jam sehari, 7 hari seminggu.</p>
                            </div>
                        </div>
                    </div>
                </div>
