        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card" style="margin-top: 150px;">
                    <div class="card-header text-center" style="background-color: #ffffff; border: none;">
                    ...
                    <div class="card-body" style="font-family: 'Arial', sans-serif; font-size: 14px; line-height: 1.6;">
                        ...
                        <div class="mb-4">
                            ...
                            <p><strong>Tanggal Reservasi:</strong> {{ $reservasi->tanggal_reservasi->format('d M Y H:i') }}
                            </p>
        ...
        <p><strong>Media Pembayaran:</strong>
            ...
            @endif
                        ...
                        <div class="text-center">
                            <button onclick="window.location.href='{{ route('reservasi.pdf', $reservasi->id) }}'"
                                class="btn btn-primary" style="border-radius: 25px; padding: 10px 20px;">
