...
<div class="container">
    <style>
        .payment-logos img {
            width: 80px;  /* Menyusun ukuran gambar agar seragam */
            height: auto;  /* Menjaga rasio aspek gambar */
            margin-right: 10px;  /* Menambahkan jarak antar gambar */
        }
        .payment-logos img {
            width: 20%;  /* Lebar gambar 20% dari kontainer .payment-logos */
            height: auto;  /* Menjaga rasio aspek gambar */
            margin-right: 10px;  /* Menambahkan jarak antar gambar */
        }
...
@endif
        ...
        <div class="card-body">
            ...
            <h4 class="mb-4">Menu yang Dipesan</h4>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Rp {{ number_format($menu->pivot->jumlah_pesanan * $menu->harga, 0, ',', '.') }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <div class="payment-total text-center mb-4">
                ...
                <h3 class="text-primary">Rp {{ number_format($totalPrice, 0, ',', '.') }}</h3>
            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" 
                                       name="e_wallet_provider" 
                                       id="{{ $code }}" 
                                       value="{{ $code }}" {{ old('e_wallet_provider') == $code ? 'checked' : '' }}>
    ...
    paymentMethodCards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            if (method === 'e-wallet') {
                ...
                selectedPaymentMethodInput.value = 'kartu_kredit';  // Make sure this is set to 'kartu_kredit'
            }
        });
    });
});
